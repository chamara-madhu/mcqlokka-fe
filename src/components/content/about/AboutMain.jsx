          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl sm:text-2xl text-purple-100 mb-8">
                One and Only Online MCQ Practice Platform for Sri Lankan
                Students
              </p>
            ...
            <div className="space-y-8">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  experienced firsthand the struggles of preparing for O/L and
                  A/L exams in Sri Lanka.
                </p>

                <p className="text-gray-700 leading-relaxed">
                  While studying and later helping others prepare, Chamara
                  noticed a critical gap: there was no dedicated online platform
                  for MCQ practice. Past papers existed only as hardcopies, were
                  extremely difficult to find online, and when available, lacked
                  answer explanations and chapter-wise organization.
                </p>

                <div className="relative pl-6 border-l-4 border-purple-500 py-2 my-8">
                  <p className="text-xl font-medium text-gray-900 italic">
                    "No student should have to struggle this much just to get
                    good practice."
                  </p>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Understanding that mastering MCQs is crucial for achieving
                  high marks in O/L and A/L exams, Chamara built MCQ Lokka—a
